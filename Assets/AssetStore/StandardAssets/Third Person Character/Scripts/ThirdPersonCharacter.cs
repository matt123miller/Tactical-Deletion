...
public class ThirdPersonCharacter : MonoBehaviour {
	...
	[SerializeField][Range(0.1f,3f)] private float moveSpeedMultiplier = 1f;
   // [SerializeField][Range(0.1f, 3f)] float crouchSpeedMultiplier = 1;// how much the move speed of the character will be multiplied by
	...
	public class AdvancedSettings
	{
        ...
        public float crouchSpeed;// speed at which capsule changes height when crouching/standing
...
// The point where the character will be looking at
